...
from Building_Blocks import ConvBNReLU, DepthwiseConvBlock, BottleneckBlock, GDConvLayer
...
class MobileFaceNet(nn.Module):
    def __init__(self, embedding_size=128):
        ...
        self.blocks = nn.Sequential(
            ...
            *[BottleneckBlock(64, 64, expansion_factor=2, stride=1) for _ in range(4)],  # Repeat 4 times
